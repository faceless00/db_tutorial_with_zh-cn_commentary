...
cuint32 LEAF_NODE_NEXT_LEAF_SIZE=sizeof(uint32_t);
cuint32 LEAF_NODE_NEXT_LEAF_OFFSET=LEAF_NODE_NUM_CELLS_OFFSET+LEAF_NODE_NUM_CELLS_SIZE;
...
//内部节点max cells
cuint32 INTERNAL_NODE_SPACE_FOR_CELLS=PAGE_SIZE-INTERNAL_NODE_HEADER_SIZE-INTERNAL_NODE_RIGHT_CHILD_SIZE;
// cuint32 INTERNAL_NODE_MAX_CELLS=INTERNAL_NODE_SPACE_FOR_CELLS/INTERNAL_NODE_CELL_SIZE;
cuint32 INTERNAL_NODE_MAX_CELLS=3; //为了测试方便,设的小一点
//
/* End */